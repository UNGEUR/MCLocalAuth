...
public class Storage {
    ...
    /**
     * RÃ©cupÃ¨re la liste des IP autorisÃ©es pour un joueur
     */
    ...
    /**
     * VÃ©rifie si une IP est autorisÃ©e pour un joueur
     */
    ...
    /**
     * Ajoute une IP autorisÃ©e pour un joueur (premiÃ¨re connexion)
     */
    ...
    /**
     * Ajoute une IP supplÃ©mentaire pour un joueur (commande admin)
     */
    public boolean addIpForPlayer(UUID uuid, String ip) {
        ...
        if (ips.contains(ip)) {
            return false; // IP dÃ©jÃ  autorisÃ©e
        }
    ...
    /**
     * Supprime une IP autorisÃ©e pour un joueur
     */
    public boolean removeIpForPlayer(UUID uuid, String ip) {
        ...
        if (ips.size() <= 1) {
            return false; // Ne peut pas supprimer la derniÃ¨re IP
        }
    ...
    /**
     * MÃ©thode de compatibilitÃ© - retourne la premiÃ¨re IP autorisÃ©e
     */
    ...
    /**
     * MÃ©thode de compatibilitÃ© - ajoute une IP
     */
